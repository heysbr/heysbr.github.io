    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start w-full max-w-2xl">
        ...
        <p className="text-lg text-gray-400 text-center sm:text-left mb-6">
          I'm a passionate web developer building modern, performant web apps. My tech stack includes <span className="font-semibold">React</span>, <span className="font-semibold">Next.js</span>, <span className="font-semibold">Zustand</span>, and <span className="font-semibold">Tailwind CSS</span>. I love learning new things every day and pushing the boundaries of what's possible on the web.
        </p>
        <div className="flex gap-4 flex-wrap justify-center sm:justify-start mb-8">
          <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-mono">React</span>
          <span className="bg-gray-100 text-gray-800  px-3 py-1 rounded-full text-sm font-mono">Next.js</span>
          <span className="bg-green-100 text-green-800  px-3 py-1 rounded-full text-sm font-mono">Zustand</span>
          <span className="bg-cyan-100 text-cyan-800  px-3 py-1 rounded-full text-sm font-mono">Tailwind</span>
        </div>
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <a
            ...
            href="mailto:priyanshu.sabaar@email.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            Contact Me
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center text-sm">
        <span>© {new Date().getFullYear()} Priyanshu Sabaar</span>
        <a
